...
repo --name="BaseOS" --baseurl=https://mirrors.xtom.de/circle/8.5/BaseOS/$basearch/os/ --cost=200
repo --name="AppStream" --baseurl=https://mirrors.xtom.de/circle/8.5/AppStream/$basearch/os/ --cost=200
repo --name="PowerTools" --baseurl=https://mirrors.xtom.de/circle/8.5/PowerTools/$basearch/os/ --cost=200
repo --name="extras" --baseurl=https://mirrors.xtom.de/circle/8.5/extras/$basearch/os --cost=200
# System timezone
timezone US/Eastern
