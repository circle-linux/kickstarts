...
shutdown
repo --name="BaseOS" --baseurl=http://mirror.cclinux.org/pub/circle/9/BaseOS/$basearch/os/ --cost=200
repo --name="AppStream" --baseurl=http://mirror.cclinux.org/pub/circle/9/AppStream/$basearch/os/ --cost=200
repo --name="CRB" --baseurl=http://mirror.cclinux.org/pub/circle/9/CRB/$basearch/os/ --cost=200
repo --name="extras" --baseurl=http://mirror.cclinux.org/pub/circle/9/extras/$basearch/os --cost=200
