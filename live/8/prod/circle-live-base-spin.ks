# circle-live-base-spin.ks
#
# Base installation information for Circle Linux images
# Contains EPEL.
#
...
basearch=$(uname -i)
rpm --import /etc/pki/rpm-gpg/RPM-GPG-KEY-circleofficial
