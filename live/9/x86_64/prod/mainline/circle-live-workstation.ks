...
FOE
  ...
  if [ -f /usr/share/anaconda/gnome/fedora-welcome.desktop ]; then
    ...
    #sed -i "s/Red Hat Enterprise/Circle/g" /usr/share/anaconda/gnome/fedora-welcome.desktop
    #sed -i "s/RHEL/Circle Linux/g" /usr/share/anaconda/gnome/fedora-welcome
    #sed -i "s/Red Hat Enterprise/Circle/g" /usr/share/anaconda/gnome/fedora-welcome
