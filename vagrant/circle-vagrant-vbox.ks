%include circle-vagrant-base.ks
%include circle-vagrant-packages-hyperv.ks
...
echo "pub/circle" > /etc/dnf/vars/contentdir
sed -i 's/^#baseurl/baseurl/g;s/^mirrorlist/#mirrorlist/g' /etc/yum.repos.d/circle*repo
